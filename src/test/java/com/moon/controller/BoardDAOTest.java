...
public class BoardDAOTest {
	 ...
	 * 
	 * BoardVO board = new BoardVO(); board.setTitle("새로운 타이틀을 넣습니다.");
	 * board.setContent("새로운 내용을 넣습니다."); board.setWriter("user00");
	 * dao.create(board); }
	 * 
	...
	/*
	 * @Test public void testURI2() throws Exception{ UriComponents uriComponents =
